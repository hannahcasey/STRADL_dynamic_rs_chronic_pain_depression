...
n_areas = size(V,1); % commented by JL % checked by LK 18/02/2023, this can stay the same, does not change the output
...
%Order = [1:2:n_areas n_areas:-2:2]; % commented by LK 18/02/2023
Order = 1:n_areas; % added by LK
